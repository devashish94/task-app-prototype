...
export default function SidebarView() {
  ...
  return (
    <>
      ...
      {/* tablet sidebar */}
      <div className={`will-change-transform overflow-auto z-50 hidden split-display:flex w-0 large:hidden h-screen duration-[300ms] transform-gpu ease-in-out transition-all ${sidebar ?
        'w-96' : 'w-0'}`}>
        <Sidebar />
      </div>

      {/* mobile sidebar */}
      <div className={`will-change-transform z-50 w-full mobile:w-72 split-display:hidden delay-0 absolute h-screen duration-[300ms] transform-gpu ease-in-out overflow-hidden transition-all ${sidebar ?
